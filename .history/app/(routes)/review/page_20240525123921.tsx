...
export default function Review(){
    ...
    return (
        <div className="flex flex-col items-center w-[100vw] h-[100vh]">
            ...
            {state?.type === "success" && <p className="text-lg p-4 rounded-md bg-green-500">{state?.message}</p>}
            {state?.type === "error" && <p className="text-lg p-4 rounded-md bg-red-500">{state?.message}</p>}
